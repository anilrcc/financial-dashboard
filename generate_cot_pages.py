    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div style="text-align: center; margin-bottom: 20px;">
                <button class="time-btn active" onclick="updatePeriod('ALL')">ALL</button>
                <button class="time-btn" onclick="updatePeriod('5Y')">5Y</button>
                <button class="time-btn" onclick="updatePeriod('1Y')">1Y</button>
            </div>
