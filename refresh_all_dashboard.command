...
echo ""
echo "[1/9] Refreshing Treasury Yields..."
python3 update_yields.py

echo ""
echo "[2/9] Refreshing Corporate Bond Spreads..."
python3 update_corporate_bonds.py

echo ""
echo "[3/9] Refreshing Money Supply (M2)..."
python3 update_money_supply.py

echo ""
echo "[4/9] Refreshing ISM Manufacturing Data..."
python3 update_ism.py

echo ""
echo "[5/9] Refreshing ISM Services Data..."
python3 update_services_ism.py

echo ""
echo "[6/9] Refreshing Consumer Sentiment..."
python3 update_consumer_sentiment.py

echo ""
echo "[7/9] Refreshing Building Permits..."
python3 update_building_permits.py

echo ""
echo "[8/9] Refreshing Small Business Optimism..."
...
echo ""
echo "[10/13] Refreshing China PMI Data..."
python3 update_china_data.py

echo ""
echo "[11/13] Refreshing Global PMI Data..."
python3 update_global_pmi.py

echo ""
echo "[12/13] Refreshing Eurozone PMI Data..."
python3 update_eurozone_data.py

echo ""
echo "[13/13] Regenerating Executive Summary & Index..."
python3 update_executive_summary.py
python3 update_cards_dates.py
